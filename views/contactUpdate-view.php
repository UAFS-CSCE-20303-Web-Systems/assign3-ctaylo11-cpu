                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="contactUpdateController.php" method="POST">
                            <input type="text" class="form-control mb-3" id="id" name="id" value="<?php echo $id; ?>" readonly>
                            <label for="username" class="form-label">Username</label>
                            <input type="text" class="form-control mb-3" id="username" name="username" value="<?php echo $username; ?>">
